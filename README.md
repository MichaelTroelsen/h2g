...
typing them, and at v0.5.453 it reports **`pass: false`**: a one-frame delay of
either side moves `aud` by 0.034, while the three documented conversion fixes
it was tested against move it by +0.012, −0.019 and −0.005 — all under that
...
`melody` (65 → 56%). Until that is resolved these are a coarse guard against
gross breakage, not a verdict.
