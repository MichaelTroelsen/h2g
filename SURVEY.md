...
| patterns | 12 | pattern decode/slicing hit a Goattracker limit |
| tracks | 2 | orderlist decode failed (usually unknown track-read version) |
...
- **12 failures are capacity, not comprehension.** These files detect cleanly (all four passes green) and fail only because the tune exceeds a Goattracker limit — 208 patterns or a 255-byte orderlist. They are the most recoverable group: splitting the orderlist across subtunes would convert them.
...
- **2 files crash on an unguarded read** (`I_Ball.sid`, `Last_V8_C128_version.sid`) — an extracted address landed outside the data section and was dereferenced without a range check.

## Converted (60)

| File | Title | Subtunes | Instr | Patterns | Ver | .sng bytes | Flag |
|---|---|---:|---:|---:|---:|---:|---|
| `5_Title_Tunes.sid` | 5 Title Tunes | 5 | 17 | 38 | 5 | 9083 |  |
| `ACE_II.sid` | ACE II | 1 | 13 | 58 | 4 | 15504 |  |
| `Action_Biker.sid` | Action Biker | 3 | 13 | 73 | 0 | 18319 |  |
| `Arcade_Classics.sid` | Arcade Classics | 1 | 24 | 110 | 7 | 32865 |  |
| `Auf_Wiedersehen_Monty.sid` | Auf Wiedersehen Monty | 13 | 17 | 169 | 2 | 42841 |  |
| `Bangkok_Knights.sid` | Bangkok Knights | 1 | 59 | 52 | 7 | 14770 | instr over-read |
| `Battle_of_Britain.sid` | Battle of Britain | 1 | 20 | 110 | 5 | 36024 |  |
| `BMX_Kidz.sid` | BMX Kidz | 4 | 23 | 90 | 2 | 30353 |  |
| `Bump_Set_Spike.sid` | Bump Set Spike | 2 | 26 | 78 | 0 | 19770 |  |
| `Chimera.sid` | Chimera | 4 | 9 | 63 | 1 | 12492 |  |
| `Commando.sid` | Commando | 19 | 14 | 65 | 0 | 15877 |  |
| `Confuzion.sid` | Confuzion | 1 | 12 | 56 | 5 | 15499 |  |
| `Crazy_Comets.sid` | Crazy Comets | 17 | 24 | 80 | 1 | 20315 |  |
| `Deep_Strike.sid` | Deep Strike | 1 | 25 | 56 | 7 | 13754 |  |
...
| `Formula_1_Simulator.sid` | Formula 1 Simulator | 2 | 16 | 37 | 0 | 10762 |  |
| `Game_Killer.sid` | Game Killer | 1 | 12 | 38 | 1 | 9400 |  |
| `Geoff_Capes_Strongman_Challenge.sid` | Geoff Capes Strongman Challenge | 24 | 22 | 55 | 0 | 11359 |  |
| `Hollywood_or_Bust.sid` | Hollywood or Bust | 10 | 21 | 84 | 0 | 22860 |  |
| `Human_Race.sid` | The Human Race | 5 | 25 | 102 | 1 | 22598 |  |
| `Hunter_Patrol.sid` | Hunter Patrol | 1 | 33 | 78 | 5 | 21844 |  |
| `IK_plus.sid` | IK+ | 3 | 31 | 51 | 7 | 13284 |  |
...
| `Last_V8.sid` | The Last V8 | 17 | 34 | 66 | 1 | 21404 |  |
| `Lightforce.sid` | Lightforce | 1 | 45 | 64 | 0 | 20663 |  |
| `Master_of_Magic.sid` | The Master of Magic | 3 | 18 | 85 | 0 | 22346 |  |
| `Mega_Apocalypse.sid` | Mega Apocalypse | 11 | 43 | 60 | 6 | 18649 |  |
| `Mozart.sid` | Mozart | 1 | 20 | 118 | 0 | 36219 |  |
| `Nemesis_the_Warlock.sid` | Nemesis the Warlock | 15 | 33 | 74 | 7 | 17537 |  |
| `Nineteen.sid` | Nineteen | 1 | 59 | 46 | 7 | 12475 | instr over-read |
| `Ninja.sid` | Ninja | 1 | 14 | 26 | 1 | 6076 |  |
| `One_Man_and_his_Droid.sid` | One Man and his Droid | 14 | 16 | 74 | 5 | 21860 |  |
| `Pandora.sid` | Pandora | 1 | 33 | 67 | 7 | 18627 |  |
| `Phantoms_of_the_Asteroid.sid` | Phantoms of the Asteroid | 4 | 0 | 96 | 1 | 26029 |  |
| `Powerplay_Hockey_USA_vs_USSR.sid` | Powerplay Hockey: USA vs USSR | 10 | 25 | 57 | 2 | 16161 |  |
| `Proteus.sid` | Proteus | 1 | 18 | 46 | 0 | 12143 |  |
| `Rasputin.sid` | Rasputin | 18 | 15 | 65 | 0 | 15974 |  |
| `Ricochet.sid` | Ricochet | 1 | 33 | 136 | 7 | 45632 |  |
| `Saboteur_II.sid` | Saboteur II | 1 | 17 | 54 | 2 | 13548 |  |
| `Samantha_Fox_Strip_Poker.sid` | Samantha Fox Strip Poker | 14 | 25 | 83 | 3 | 15322 |  |
| `Sanxion.sid` | Sanxion | 2 | 60 | 69 | 0 | 22785 | instr over-read |
| `Shockway_Rider.sid` | Shockway Rider | 1 | 27 | 76 | 7 | 20793 |  |
| `Sigma_Seven.sid` | Sigma Seven | 1 | 17 | 25 | 0 | 6798 |  |
| `Skate_or_Die_intro.sid` | Skate or Die (intro) | 1 | 17 | 53 | 7 | 13667 |  |
| `Spellbound.sid` | Spellbound | 13 | 26 | 111 | 0 | 36575 |  |
| `Star_Paws.sid` | Star Paws | 3 | 41 | 53 | 7 | 13996 |  |
| `Tarzan.sid` | Tarzan | 12 | 40 | 53 | 0 | 13283 |  |
| `Thanatos.sid` | Thanatos | 1 | 20 | 25 | 0 | 8736 |  |
| `Thing_on_a_Spring.sid` | Thing on a Spring | 17 | 16 | 66 | 5 | 19269 |  |
| `Thrust.sid` | Thrust | 1 | 29 | 63 | 0 | 17613 |  |
| `Thundercats.sid` | Thundercats | 16 | 59 | 41 | 7 | 12860 | instr over-read |
...
| `Warhawk.sid` | Warhawk | 18 | 29 | 70 | 0 | 17650 |  |
...
| `I_Ball.sid` | I, Ball | detect | - | - | - | - | IndexError: index out of range |
...
| `Gerry_the_Germ.sid` | Gerry the Germ | patterns | y | y | y | y | TRACKLIST TOO LONG, CAN'T EXPORT TO GOATTRACKER |
...
| `Last_V8_C128_version.sid` | The Last V8 (C128 version) | tracks | y | y | y | y | IndexError: index out of range |
